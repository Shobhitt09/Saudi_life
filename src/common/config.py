...
REDIS_HOST = os.getenv("REDIS_HOST", "redis-13474.crce176.me-central-1-1.ec2.redns.redis-cloud.com")
REDIS_PORT = int(os.getenv("REDIS_PORT", 13474))
REDIS_PASSWORD = os.getenv("REDIS_PASSWORD", "dDhruLrl3mXFWpWOZ7OfcScxajKjgPqI")
